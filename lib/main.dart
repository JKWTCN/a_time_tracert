...
import 'package:a_time_tracert/chartPage/chart_page.dart';
import 'package:a_time_tracert/myPage/my_page.dart';
import 'package:sqflite_common_ffi/sqflite_ffi.dart';
import 'kindPage/kind_page.dart';
import 'db_helper.dart';
import 'recordPage/record_page.dart';
...
class _MyHomepageState extends State<MyHomepage> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        // appBar: AppBar(
        //   title: const Text('aTimeTracert'),
        //   actions: <Widget>[
        //     IconButton(icon: const Icon(Icons.flip_to_front), onPressed: () {}),
        //   ],
        // ),
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: const [
            ...
            BottomNavigationBarItem(icon: Icon(Icons.flag), label: '种类'),
